package com.cache.eshop.inventory.controller;

import com.cache.eshop.inventory.model.ProductInventory;
import com.cache.eshop.inventory.request.ProductInventoryCacheReloadRequest;
import com.cache.eshop.inventory.request.ProductInventoryDBUpdateRequest;
...
import com.cache.eshop.inventory.vo.Response;
...
public class ProductInventoryController {
   ...
   System.out.println("wwwwwwwwwwwww:接受到updateProductInventory请求，商品ID="+productInventory.getInventoryNum());
    ...
    public ProductInventory getProductInventory(Integer productId) {
        System.out.println("rrrrrrrrrrrrrrr: 接收到getProductInventory请求，商品id=" + productId);
...
//                }
                ...
                if (productInventory != null) {
                    System.out.println("rrrrrrrrrrrrrrrrrrr: 在200ms内读取到了redis中的库存缓存，商品id=" + productInventory.getProductId() + ", 商品库存数量=" + productInventory.getInventoryNum());
