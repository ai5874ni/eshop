package com.cache.eshop.inventory.threadpool;
    ...
    public Boolean call() throws Exception {
        try {
            while (true) {
                ...
                System.out.println("===========日志===========: queue.take()");
                ...
                if(!forceRfresh) {
                    ...
                    if(request instanceof ProductInventoryDBUpdateRequest) {
                        ...
                        if(flag != null && !flag) {
                            ...
                            System.out.println("rrrrrrrrrrrrrrrrr:直接就过滤掉");
                            continue;
                        }
                    }
                }
        ...
        System.out.println("===========日志===========: return true");
        return true;
    }
